...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _renderLoader = rowData => {
    if (rowData.isLoading === true) {
      return <View style={[defaultStyles.loader, this.props.styles.loader]}>{this._getRowLoader()}</View>;
    }
  ...
  _renderSeparator = (sectionID, rowID) => {
    ...
    return <View key={`${sectionID}-${rowID}`} style={[defaultStyles.separator, this.props.styles.separator]} />;
  };
  ...
  _renderPoweredLogo = () => {
    ...
    return (
      <View style={[defaultStyles.row, defaultStyles.poweredContainer, this.props.styles.poweredContainer]}>
        <Image
  ...
  render() {
    ...
    return (
      <View style={[defaultStyles.container, this.props.styles.container]} pointerEvents="box-none">
